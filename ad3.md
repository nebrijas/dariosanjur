...
Librerias que ya vienen instaladas con python:
...
Librerias que se instalaron a traves del comando pip:
...
Consiste en hacer **scrapping** en las siguiente paginas:
...
Se tomara los titulos de estas paginas y posteriormente se realizara una categorizacion con las siguientes palabras clave:
...
Se consulta todos las paginas y se buscan el codigo html `h2` y guardan el resultado en la variable `resultados`
...
#### 2. Categorizar titulos por palabras

Se categoria los titulos por palabras clave
